...
Conditional independence assumptions allow us to decompose a complex joint distribution into a product of simpler conditional distributions — each of which may involve only a few variables. This decomposition is the key to building tractable generative models, and we will see many examples throughout the course.
...
### Problem: Twins and uncles

Consider a woman, II2, who is pregnant with twin boys (III2 and III3). We want to know the probability that one or both of her unborn sons will be affected by the disorder. (We use standard pedigree notation: Roman numerals indicate generation and Arabic numerals indicate position within a generation.)
...
We will build a generative model of this family tree and use conditioning to compute the probability in question.
