...
Each parametric distribution defines a **base family** — a kernel $k_{\text{base}} : \Theta \kernel Y$ that takes a parameter value as input and returns the corresponding distribution. We discuss the three most common ones here; @sec-parametric-families-appendix lists further families available in PyTorch.
