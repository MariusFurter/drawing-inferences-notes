...
(\nu_U \otimes \nu_V)(B_1 \times B_2) = \nu_U(B_1) \cdot \nu_V(B_2).
$$
For instance, Lebesgue measure on $\mathbb{R}^2$ (area) is the product of Lebesgue measure on $\mathbb{R}$ (length) with itself. Product measures appear naturally when a kernel has multiple outputs: if each output has a base measure, the joint base measure is their product.
:::
