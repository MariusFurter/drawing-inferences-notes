# Parametric kernels reference {.unnumbered #sec-parametric-families-appendix}

<!-- Proof-read this! -->

This appendix collects the building blocks of parametric kernels: 

- @sec-distributional-families-appendix , 
- @sec-predictors-appendix ,
- @sec-response-maps-appendix ,
- @sec-output-transforms-appendix , 
- @sec-input-transforms-appendix . 

Each parametric kernel is assembled by composing one choice from each category, as described in @sec-parametric-kernels.
