...
- [cpg_train.csv](../data/exercise-4/cpg_train.csv) — 2000 nucleotide positions with labeled hidden states (for parameter estimation)
...
- [vol_train.csv](../data/exercise-4/vol_train.csv) — 1000 trading days with labeled regimes (for parameter estimation)
...
# Load training data
cpg_train_df = pd.read_csv("../data/exercise-4/cpg_train.csv")
cpg_train_df.head()
```
...
cpg_test_file = "../data/exercise-4/cpg_test.csv"
cpg_labels_file = "../data/exercise-4/cpg_test_labels.csv"
...
# Load training data
vol_train_df = pd.read_csv("../data/exercise-4/vol_train.csv")
vol_train_df.head()
```
...
# File paths and column names
vol_test_file = "../data/exercise-4/vol_test.csv"
vol_labels_file = "../data/exercise-4/vol_test_labels.csv"
